            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo $home_url;?>" style="margin-top: -5px;padding: 0 15px;">
                        <img src="<?php echo $base_url.'/';?>images/newhopelogo5.svg" alt="logo"  width="auto">
                    </a>
                </div>
                    ...
                    <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                        ...
                        <li class="dropdown <?php echo $about_active;?>">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="<?php echo $about_url.'#mission';?>">Mission Statement</a></li>
                                <li><a href="<?php echo $about_url.'#vision';?>">Message from MD</a></li>
                        ...
                        <li class="dropdown <?php echo $service_active;?>">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="<?php echo $services_url.'?reqpage=general_medical';?>">General Medical</a></li>
                        ...
                        <li class="<?php echo $blog_active;?>"><a href="<?php echo $blog_url;?>">Blogs</a></li>
